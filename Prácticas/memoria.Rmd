...
Del mismo modo también vamos a eliminar el campo en el que se recoge la fecha en la que se creó la crítica puesto que tampoco nos aporta información útil para aplicar los sucesivos algoritmos.
```{r important fields}
