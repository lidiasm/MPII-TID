...
############################# EXPLICAR LOS RESULTADOS CON LA FUENTE: https://rpubs.com/osoramirez/316691
##### INTENTAR EXPLICAR LAS GRÁFICAS QUE SE SACAN
##### APLICAR EL MISMO TRATAMIENTO AL CONJUNTO DE TEST
##### HACER UNA FUNCIÓN PARA MEDIR LOS ERRORES DEL MODELO CON EL TEST -> ANDREA / AA
##### CURVA ROC
summary(regresion_lineal)
par(mfrow = c(2, 2))
plot(regresion_lineal)
# Verificamos su tasa de error con el conjunto de test.
```